1. В файле urls.py проекта recipes сделал два импорта:
- from django.contrib import admin
- from django.urls import path, include
2. В файле urls.py проекта recipes отслеживаю url адреса:
- path('admin/', admin.site.urls),
- path('', include('calculator'))
3. В приложении calculator создаю файл urls.py
4. В файле calculator/urls.py делаю импорты:
- from django.urls import path, include
- from . import views
5. В файле calculator/views.py делаю импорты: 
- from django.http import HttpResponse
6. В файле calculator/views.py делаю функцию для главной страницы:
- from django.http import HttpResponse
